...
- Para una mejor gestion de las solicitudes y propuestas se ha aprovechado la herramienta  de [Formspree](https://formspree.io/) que permite la creación y gestión de formularios sin la necesidad de aplicaciones o código supletorio, ya que es una API que incorpora control de errores y protección de datos.
